...
const doctorOstCities = ["Алматы", "Челябинск", "Екатеринбург", "Нижний Новгород", "Казань", "Краснодар", "Красноярск", "Новосибирск", "Пермь", "Самара", "Тюмень", "Уфа"];
...
var gender_picker = __webpack_require__(8566);
...
;// CONCATENATED MODULE: ./src/js/components/date-label.js
...
;// CONCATENATED MODULE: ./src/js/components/custom-scrollbar.js
...
var next_button = __webpack_require__(9612);
